...
public class GetDataFromExcelFile {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException, ParseException {
		WebDriver driver;
		...
		wdUtility.maximizeWindow();
		//driver.manage().window().maximize();
		wdUtility.waitForPageLoad();
	//	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));
		...
		wdUtility.scrollToElement(submit);
	...
	//	act.scrollToElement(submit).build().perform();
		...
		wait.until(ExpectedConditions.visibilityOf(interviewTitle)).sendKeys(interviewtitle);
		WebElement interviewer=driver.findElement(By.xpath("//label[text()='Interviewer']/following::input[1]"));
		wait.until(ExpectedConditions.visibilityOf(interviewer)).sendKeys(iname);
		Thread.sleep(3000);
		...
		WebElement date1=driver.findElement(By.xpath("//label[text()='Date']/following::input[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(date1)).sendKeys(date);
		driver.findElement(By.xpath("//label[text()='Time']/following::input[1]")).sendKeys(time);
